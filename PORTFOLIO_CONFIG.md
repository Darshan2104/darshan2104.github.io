...
This file contains all the configurable content for the portfolio website. Simply edit the values below and rebuild the site to see changes.
...
```json
{
  "skillCategories": [
    ...
    },
    {
      ...
      "icon": "Brain",
      "items": ["Deep Learning", "Neural Networks", "LLM", "RAG", "Prompt Engineering", "LangChain"]
    },
    {
...
```json
{
  ...
  "contactSubtitle": "Ready to collaborate on your next AI/ML project? Let's discuss how we can bring your ideas to life.",
  "contactDescription": "I'm always excited to discuss new opportunities, innovative projects, and potential collaborations. Whether you're looking to implement AI solutions or need expert consultation, let's connect!"
}
```
...
1. **Personal Info**: Update name, title, email, etc. in the Personal Information section
2. **Social Links**: Add/remove/modify social media links
3. **Skills**: Modify skill categories, add new technologies
4. **Experience**: Update job details, achievements, technologies used
5. **Projects**: Add new projects, update descriptions and links
6. **Contact**: Modify contact information and descriptions

After making changes, run `npm run build` to apply the updates to your website.